...
const translations = {
  en: {
    ...
    voice_quota: 'Voice Quota', mins_left: 'min left', get_mins: 'Get More Minutes', live_conn: 'Live Connection', connecting: 'Connecting...', ready: 'Ready', tap_to_start: 'Tap Call to start', listening: 'Listening...', hi: 'Hi',     upgrade_title: 'Upgrade Your Experience',
    upgrade_sub: 'Unlock the full potential of your AI companion with extended memory and voice minutes.',
    tab_monthly: 'Monthly',
    tab_yearly: 'Yearly',
    ...
    sub_success: 'Subscription Successful',
    welcome_plan: 'Welcome to %{planName}! Your account has been upgraded.',
    btn_start_talking: 'Start Talking',
    footer_restore: 'Restore Purchases',
    footer_terms: 'Terms',
    footer_privacy: 'Privacy',
    feat_voice_mins: '%{minutes} Voice Minutes / month',
    feat_timeout: '%{minutes}-Minute Idle Timeout',
    feat_all_domains: 'All Knowledge Domains',
    feat_custom_persona: 'Custom Persona & Lore',
    feat_ai_filtering: 'Standard AI Filtering',
    feat_priority_model: 'Priority Model Processing',
    feat_deep_memory: 'Deep Core Memory',
    feat_priority_routing: 'Priority Server Routing'
  },
  ru: {
    ...
    voice_quota: 'Голосовая квота', mins_left: 'мин осталось', get_mins: 'Добавить минуты', live_conn: 'В сети', connecting: 'Соединение...', ready: 'Готов', tap_to_start: 'Нажмите для звонка', listening: 'Слушаю...', hi: 'Привет',     upgrade_title: 'Расширьте возможности',
    upgrade_sub: 'Раскройте весь потенциал вашего ИИ-компаньона: больше памяти и голосовых минут.',
    tab_monthly: 'Ежемесячно',
    tab_yearly: 'Ежегодно',
    save_badge: 'СКИДКА %{percent}%',
    whats_included: 'ЧТО ВКЛЮЧЕНО:',
    billed_annually: 'Списывается ежегодно',
    billed_monthly: 'Списывается ежемесячно',
    total_lbl: 'Итого:',
    btn_subscribe: 'Оформить подписку',
    sub_success: 'Подписка оформлена',
    welcome_plan: 'Добро пожаловать в %{planName}! Ваш аккаунт обновлен.',
    btn_start_talking: 'Начать общение',
    footer_restore: 'Восстановить покупки',
    footer_terms: 'Условия',
    footer_privacy: 'Конфиденциальность',
    feat_voice_mins: '%{minutes} голосовых минут / месяц',
    feat_timeout: 'Таймаут ожидания %{minutes} минут',
    feat_all_domains: 'Все базы знаний',
    feat_custom_persona: 'Свой персонаж и история',
    feat_ai_filtering: 'Стандартная AI-фильтрация',
    feat_priority_model: 'Приоритетная обработка моделью',
    feat_deep_memory: 'Глубокая память',
    feat_priority_routing: 'Приоритетная маршрутизация'
  },
  es: { 
    ...
    welcome: 'Bienvenido', auth_subtitle: 'Inicia sesión', email: 'Correo', password: 'Clave', continue: 'Continuar', or_continue: 'o con', error_empty: 'Error: Campos vacíos', reg_success: 'Registro exitoso', login_success: 'Inicio de sesión exitoso',
    ...
    voice_quota: 'Cuota', mins_left: 'min restantes', get_mins: 'Más min', live_conn: 'En línea', connecting: 'Conectando...', ready: 'Listo', tap_to_start: 'Toca para llamar', listening: 'Escuchando...', hi: 'Hola' 
  },
  fr: { 
    ...
    welcome: 'Bienvenue', auth_subtitle: 'Connexion', email: 'Email', password: 'MDP', continue: 'Continuer', or_continue: 'ou avec', error_empty: 'Erreur : Champs vides', reg_success: 'Inscription réussie', login_success: 'Connexion réussie',
    ...
    voice_quota: 'Quota', mins_left: 'min restantes', get_mins: 'Plus min', live_conn: 'En ligne', connecting: 'Connexion...', ready: 'Prêt', tap_to_start: 'Appuyez pour appeler', listening: 'Écoute...', hi: 'Salut' 
  },
  de: { 
    ...
    welcome: 'Willkommen', auth_subtitle: 'Anmelden', email: 'E-Mail', password: 'Passwort', continue: 'Weiter', or_continue: 'oder mit', error_empty: 'Fehler: Leere Felder', reg_success: 'Registrierung erfolgreich', login_success: 'Anmeldung erfolgreich',
    ...
    voice_quota: 'Limit', mins_left: 'Min. übrig', get_mins: 'Mehr', live_conn: 'Online', connecting: 'Verbinden...', ready: 'Bereit', tap_to_start: 'Tippen zum Anrufen', listening: 'Zuhören...', hi: 'Hallo' 
  },
  it: { 
    ...
    welcome: 'Benvenuto', auth_subtitle: 'Accedi', email: 'Email', password: 'Password', continue: 'Continua', or_continue: 'o con', error_empty: 'Errore: Campi vuoti', reg_success: 'Registrazione completata', login_success: 'Accesso effettuato',
    ...
    voice_quota: 'Quota', mins_left: 'min rimasti', get_mins: 'Più min', live_conn: 'In linea', connecting: 'Connessione...', ready: 'Pronto', tap_to_start: 'Tocca per chiamare', listening: 'In ascolto...', hi: 'Ciao' 
  },
  pt: { 
    ...
    welcome: 'Bem-vindo', auth_subtitle: 'Entrar', email: 'E-mail', password: 'Senha', continue: 'Continuar', or_continue: 'ou com', error_empty: 'Erro: Campos vazios', reg_success: 'Registro bem-sucedido', login_success: 'Login bem-sucedido',
    ...
    voice_quota: 'Cota', mins_left: 'min restantes', get_mins: 'Mais min', live_conn: 'Conectado', connecting: 'Conectando...', ready: 'Pronto', tap_to_start: 'Toque para ligar', listening: 'Ouvindo...', hi: 'Olá' 
  },
  zh: { 
    legal_title: '法律同意', legal_body: '同意即表示您接受并确认您正在与人工智能进行互动。\n\n本系统专为娱乐目的而设计，不构成任何形式的咨询。', legal_btn: '我同意', 
    welcome: '欢迎', auth_subtitle: '登录', email: '电邮', password: '密码', continue: '继续', or_continue: '或其他', error_empty: '错误：字段为空', reg_success: '注册成功', login_success: '登录成功',
    ...
    voice_quota: '限额', mins_left: '分钟剩余', get_mins: '更多', live_conn: '已连接', connecting: '连接中...', ready: '准备就绪', tap_to_start: '点击通话', listening: '聆听中...', hi: '你好' 
  },
  ja: { 
    ...
    welcome: 'ようこそ', auth_subtitle: 'ログイン', email: 'メール', password: 'パス', continue: '続行', or_continue: '他', error_empty: 'エラー：空のフィールド', reg_success: '登録成功', login_success: 'ログイン成功',
    ...
    voice_quota: '枠', mins_left: '分残り', get_mins: '追加', live_conn: 'オンライン', connecting: '接続中...', ready: '準備完了', tap_to_start: 'タップして通話', listening: 'リスニング...', hi: 'こんにちは' 
  },
  ko: { 
    ...
    welcome: '환영합니다', auth_subtitle: '로그인', email: '메일', password: '비번', continue: '계속', or_continue: '다른', error_empty: '오류: 빈 필드', reg_success: '등록 성공', login_success: '로그인 성공',
    ...
    voice_quota: '한도', mins_left: '분 남음', get_mins: '추가', live_conn: '온라인', connecting: '연결 중...', ready: '준비 완료', tap_to_start: '탭하여 통화', listening: '듣는 중...', hi: '안녕하세요' 
  },
  ar: { 
    ...
    welcome: 'أهلاً', auth_subtitle: 'دخول', email: 'بريد', password: 'كلمة', continue: 'متابعة', or_continue: 'أو', error_empty: 'خطأ: حقول فارغة', reg_success: 'تم التسجيل بنجاح', login_success: 'تم تسجيل الدخول بنجاح',
    ...
    voice_quota: 'حصة', mins_left: 'دقائق', get_mins: 'المزيد', live_conn: 'متصل', connecting: 'جاري الاتصال...', ready: 'جاهز', tap_to_start: 'اضغط للاتصال', listening: 'أستمع...', hi: 'أهلاً' 
  },
  hi: { 
    ...
    welcome: 'स्वागत', auth_subtitle: 'लॉगिन', email: 'ईमेल', password: 'पासवर्ड', continue: 'जारी', or_continue: 'अन्य', error_empty: 'त्रुटि: खाली फ़ील्ड', reg_success: 'पंजीकरण सफल', login_success: 'लॉगिन सफल',
    ...
    voice_quota: 'कोटा', mins_left: 'मिनट', get_mins: 'अधिक', live_conn: 'ऑनलाइन', connecting: 'कनेक्ट हो रहा है...', ready: 'तैयार', tap_to_start: 'कॉल करने के लिए टैप करें', listening: 'सुन रहा हूँ...', hi: 'नमस्ते' 
  }
};
